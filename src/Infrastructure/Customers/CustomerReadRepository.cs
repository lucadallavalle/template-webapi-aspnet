...
/// <summary>
/// Read repository for <see cref="Customer"/> entities. Supplies the entity-specific search and sort
/// behaviour on top of <see cref="ReadRepositoryBase{T}"/>.
/// </summary>
...
{
    // Customer only carries an Id in this template. For a real entity, override ApplySearch to declare
    // which fields are searchable, e.g.:
    //
